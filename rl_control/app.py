...
col1.metric('Wave Speed', '2 mph', '0.0%')
...
if st.sidebar.button('Generate Data'):
    ...
    col4.metric('Wave Speed', f'{round(wave_speed, 2)}', f'{round((wave_speed/2)*100, 2)}%')
    col5.metric('Wave Height', f'{round(wave_height, 2)}', f'{round((wave_height/3)*100, 2)}%')
    col6.metric('Accuracy', '80%', f'{round((80/27), 2)}%')
